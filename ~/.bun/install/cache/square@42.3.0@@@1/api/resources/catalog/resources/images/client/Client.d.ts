...
export declare class Images {
     ...
     */
    create(request: Square.catalog.CreateImagesRequest, requestOptions?: Images.RequestOptions): Promise<Square.CreateCatalogImageResponse>;
    /**
     ...
     *     })
     */
    update(request: Square.catalog.UpdateImagesRequest, requestOptions?: Images.RequestOptions): Promise<Square.UpdateCatalogImageResponse>;
