...
export declare class CustomAttributes {
     ...
     *     })
     */
    batchDelete(request: Square.locations.BulkDeleteLocationCustomAttributesRequest, requestOptions?: CustomAttributes.RequestOptions): Promise<Square.BulkDeleteLocationCustomAttributesResponse>;
    /**
     ...
     *     })
     */
    batchUpsert(request: Square.locations.BulkUpsertLocationCustomAttributesRequest, requestOptions?: CustomAttributes.RequestOptions): Promise<Square.BulkUpsertLocationCustomAttributesResponse>;
    /**
     ...
     *     })
     */
    get(request: Square.locations.GetCustomAttributesRequest, requestOptions?: CustomAttributes.RequestOptions): Promise<Square.RetrieveLocationCustomAttributeResponse>;
    /**
     ...
     *     })
     */
    upsert(request: Square.locations.UpsertLocationCustomAttributeRequest, requestOptions?: CustomAttributes.RequestOptions): Promise<Square.UpsertLocationCustomAttributeResponse>;
    /**
     ...
     *     })
     */
    delete(request: Square.locations.DeleteCustomAttributesRequest, requestOptions?: CustomAttributes.RequestOptions): Promise<Square.DeleteLocationCustomAttributeResponse>;
